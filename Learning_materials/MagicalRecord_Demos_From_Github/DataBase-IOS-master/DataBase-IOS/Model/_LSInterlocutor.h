...
// Make changes to LSInterlocutor.h instead.

#import <CoreData/CoreData.h>

extern const struct LSInterlocutorAttributes {
...
} LSInterlocutorAttributes;

@interface LSInterlocutorID : NSManagedObjectID {}
@end

@interface _LSInterlocutor : NSManagedObject {}
+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_;
+ (NSString*)entityName;
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) LSInterlocutorID* objectID;
...
@interface _LSInterlocutor (CoreDataGeneratedPrimitiveAccessors)
